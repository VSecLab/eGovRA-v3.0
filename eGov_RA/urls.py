...
urlpatterns = [
    ...
    path('threat_agent_wizard/<int:systemId>/<int:processId>', views.threat_agent_wizard, name='threat_agent_wizard'),
    path('threat_agent_generation/<int:systemId>/<int:processId>', views.threat_agent_generation, name='threat_agent_generation'),
    path('calculate_threat_agent_risks/<int:systemId>/<int:processId>', views.calculate_threat_agent_risks, name='calculate_threat_agent_risks'),
